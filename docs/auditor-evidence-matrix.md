...
| Evals and calibration | Deterministic eval smoke, agent multi-hop evals, dataset-backed adapters, and path-safe 200-record/40-case calibration evidence with release metric gates are documented and checked offline. | `make eval-smoke`, `make eval-agent-multihop`, and `make eval-calibration-gate` | Pilot-ready evidence; broader public calibration remains a promotion decision. |
