...
| Release and production handoff | Release workflow requests GHCR publish, SBOM/provenance, Cosign signing/verification, visual audit artifacts, audit manifest artifacts, and a machine-checked human promotion evidence template. | `make release-check`, `make production-preflight`, and `make promotion-template-check` | Not production-promoted until tag publish, real digests, SBOM/provenance, Cosign evidence, and target-environment review are recorded. |
