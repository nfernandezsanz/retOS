...
| 90% or better test coverage | Backend total coverage is 95.21%; branch coverage is ratcheted at 90.45%. Tests and eval smoke avoid paid providers. | `make check` | Local evidence ready; coverage numbers must be refreshed when the suite changes. |
