...
evidence plus journal/progress hash-chain events and a valid limited audit export. A
limited export can report continuity gaps at the window boundary while still requiring
valid hash integrity and zero hash failures. Use it after UI/API changes when
