...
| Backend coverage | Passing total coverage, branch ratchet in progress | `README.md` records 93.03% total and 85.69% branch-only coverage. |
...
| Final branch target | Not complete | Branch coverage is ratcheted at 85.69%; the target remains 90%. |
