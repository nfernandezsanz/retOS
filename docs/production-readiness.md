...
| Backend quality | `make check` | Black and Ruff/PEP 8 for backend code plus root Python audit/release scripts, mypy, 735 pytest cases, eval smoke, agent multi-hop eval, 95.43% total coverage, and 90.78% branch coverage. |
