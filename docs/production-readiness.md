...
| Backend coverage | Passing total coverage, branch ratchet in progress | `README.md` records 92.32% total and 84.31% branch-only coverage. |
...
| Final branch target | Not complete | Branch coverage is ratcheted at 84.31%; the target remains 90%. |
