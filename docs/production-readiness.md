...
| Backend coverage | Passing total coverage, branch ratchet in progress | `README.md` records 91.86% total and 83.43% branch-only coverage. |
...
| Final branch target | Not complete | Branch coverage is ratcheted at 83.43%; the target remains 90%. |
