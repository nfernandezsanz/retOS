...
| Backend coverage | Passing total and branch coverage | `README.md` records 95.39% total and 90.73% branch-only coverage. |
...
| Backend quality | `make check` | Black, Ruff/PEP 8, mypy, 622 pytest cases, eval smoke, agent multi-hop eval, 95.39% total coverage, and 90.73% branch coverage. |
