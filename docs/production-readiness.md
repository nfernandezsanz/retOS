...
| Backend coverage | Passing total and branch coverage | `README.md` records 95.41% total and 90.77% branch-only coverage. |
...
| Backend quality | `make check` | Black, Ruff/PEP 8, mypy, 629 pytest cases, eval smoke, agent multi-hop eval, 95.41% total coverage, and 90.77% branch coverage. |
