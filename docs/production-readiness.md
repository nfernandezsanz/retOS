...
| Backend coverage | Passing total coverage, branch ratchet in progress | `README.md` records 94.17% total and 87.96% branch-only coverage. |
...
| Final branch target | Not complete | Branch coverage is ratcheted at 87.96%; the target remains 90%. |
