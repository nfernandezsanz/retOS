...
| Backend coverage | Passing total coverage, branch ratchet in progress | `README.md` records 91.80% total and 83.28% branch-only coverage. |
...
| Final branch target | Not complete | Branch coverage is ratcheted at 83.28%; the target remains 90%. |
