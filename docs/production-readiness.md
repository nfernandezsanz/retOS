...
| Backend quality | `make check` | Black and Ruff/PEP 8 for backend code plus root Python audit/release scripts, mypy, 785 pytest cases, eval smoke, agent multi-hop eval, 95.42% total coverage, and 90.75% branch coverage. |
