...
| --- | --- |
| Navigate the console | Use the compact Overview, then switch to Documents, Queries, Evals, Audit, or Admin; each long screen has module pills and a current-context band for its main task areas |
...
- A React + TypeScript + Vite frontend scaffold focused on operational visibility for
  ...
  sections, plus contextual module pills and current-context bands that shorten
