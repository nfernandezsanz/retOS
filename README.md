...
| Visual audit screenshots | `make frontend-visual-audit` | Generates ignored desktop and mobile PNG snapshots under `frontend/visual-audit/` using the same mocked brand smoke scenario. |
