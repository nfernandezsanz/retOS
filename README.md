...
| Audit handoff manifest | `make audit-manifest OUTPUT=evals/reports/audit-manifest.json` | Exports commit state, generation context, required gates, critical file hashes including the auditor evidence matrix, visual audit screenshot records, and remaining external promotion evidence as JSON. |
