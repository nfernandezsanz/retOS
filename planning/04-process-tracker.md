...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 - Open Source Bootstrap | In progress | Scaffold created | Backend, API smoke, frontend, browser smoke, Docker build, Docker stack smoke wired | 93.26% backend | Initial events only | In progress | Full product flows pending |
| 1 - Core Domain And Persistence | In progress | Domain/source persistence, Alembic catalog schema, durable jobs API | Unit/API smoke/migration coverage | 93.26% backend | Job creation writes journal and progress events | API and database guides added | Document APIs still pending |
