...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 - Open Source Bootstrap | In progress | Scaffold created | Backend, API smoke, frontend, browser smoke, Docker build, Docker stack smoke wired | 93.53% backend | Initial events only | In progress | Full product flows pending |
| 1 - Core Domain And Persistence | In progress | Domain/source persistence plus Alembic catalog schema | Unit/API smoke/migration coverage | 93.53% backend | Journal/progress tables added | API and database guides added | Document/job APIs still pending |
