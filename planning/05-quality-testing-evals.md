...
- Current branch-only ratchet: 90.65%, enforced by CI after focused branch tests
...
`BRANCH_COVERAGE_MIN=90.65 make test` when auditing readiness against the current
